...
![A GitHub repository URL with a prompt to replace with smart chip using the
tab key.](./chip.png)

You can also convert an existing link in the link popup.

![A prompt to replace the URL with either a link or chip.](./replace.png)
...
![A preview card showing repository details.](./repo.png)
...
![A preview card showing issue details.](./issue.png)
...
![A preview card showing pull request details.](./pr.png)
